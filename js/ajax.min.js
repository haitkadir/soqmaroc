/*start my custom ajax file*/
//for share this product in whatsapp
/*
function open_whatsapp() {
    var id = $('.share-box .whats').attr('data_Id');
    $.ajax({
      type: 'HEAD',
      url: 'whatsapp://send?text=text=' + id,
      success: function() {
        window.location='whatsapp://send?text=text=' + id;
      },
      error: function() {
        alert("يجب تثبيث الواتساب اولا");
      }
    });
  }
*/
//this variables for loading data from db using ajax
...
upload4.addEventListener("change", (e) => {
    ...
    $('.form-upload .submit').on('click', function () {
        $(this).parent('.form-upload').submit();
    });
